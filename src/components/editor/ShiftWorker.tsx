...
const ShiftWorker: React.FC<ShiftWorkerProps> = ({ day, workerId, error }) => {
  // 기본 정보를 가져옴
  error = error ?? "";
  ...
  return (
    <div
      ...
      style={{
        ...
        height: isEditing || errorMsg.length > 0 ? "80px" : "60px",
        borderColor: isEditing ? "blue" : errorMsg.length > 0 ? "red" : "",
      }}
    >
      <div
      ...
      <div className="editor-shift-worker-info">
